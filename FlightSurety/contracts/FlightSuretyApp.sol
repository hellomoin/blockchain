...
contract FlightSuretyApp {
    ...
    */
    ...
    {
        require(flightSuretyData.isActive(msg.sender), "This account hasn't enough funding, so not active for airline operational actions.");
        _;
    }
    ...
    */  
    function registerFlight (
                            ...
                            string destination,
                            uint256 timestamp
                            ) external requireIsOperational requireIsAirlineActive
    {
...
contract FlightSuretyData {
    ...
    function registerAirline(address airlineAddress, string name) external returns(bool);
    ...
    function pay (address insuredPassenger) payable public returns (uint256, uint256, uint256, uint256, address, address);
}
*/